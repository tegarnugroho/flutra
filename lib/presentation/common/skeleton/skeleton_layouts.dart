...
/// The current-SDK card followed by the versions group.
      ...
      children: [
        GroupedBox(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: const [
              SkeletonLine(width: 168, height: 15),
              SizedBox(height: 12),
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  SkeletonBox(width: 96, height: 26),
                ],
              ),
            ],
          ),
            ...
            for (final width in const [96.0, 112.0, 88.0, 104.0])
              _SkeletonRow(
                children: [
                  SkeletonLine(width: width, height: 12),
                  const Spacer(),
                  const SkeletonBox(width: 66, height: 20),
                ],
              ),
          ],
        ),
...
/// Rows for the Settings screen's one async section (saved addresses).
///
/// The rest of Settings reads local preferences and renders instantly, so it
/// gets no skeleton.
class AddressListSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SkeletonShimmer(
      child: Column(
        children: [
          for (final width in const [164.0, 132.0, 196.0])
            _SkeletonRow(
              height: 30,
              children: [
                const SkeletonCircle(size: 16),
                ...
                Column(
                  ...
                  children: [
                    SkeletonLine(width: width, height: 12),
                    const SizedBox(height: 5),
                    SkeletonLine(width: width * 0.6, height: 10),
                  ],
                ),
              ],
            ),
